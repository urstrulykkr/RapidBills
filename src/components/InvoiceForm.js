...
class InvoiceForm extends React.Component {
  ...
  render() {
      ...
      <Row>
        <Col md={8} lg={9}>
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            ...
            <Form.Control placeholder="Thank you & visit again!" name="notes" value={this.state.notes} onChange={(event) => this.editField(event)} as="textarea" className="my-2" rows={1}/>
          </Card>
        </Col>
        <Col md={4} lg={3}>
    ...
    <footer style={{ textAlign: 'center', marginTop: '20px' }}>
          <p>© 2023 Kaushik Reddy. Made in College Park, with ❤️ and 🧠</p>
        </footer>
    </div>)
  }
}
